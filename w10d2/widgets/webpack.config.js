...
module.exports = {
  ...
  output: {
    //where webpack should output the bundled files
  ...
  resolve: {
    //accepts a resolve key, which lets you specify what file extensions to process without explicitly naming them when we import export. You must include the star matcher '*' to be able to include files with an explicit extension.
    extensions: [".js", ".jsx", "*"],
  },
  module: {
    //allows you to specify several loaders within our webpack configuration. This is a concise way to display loaders, and helps to maintain clean code.
